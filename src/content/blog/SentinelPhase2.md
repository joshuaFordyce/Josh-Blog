...
Lessons from the Docker Trenches:
...
Python and Docker errors are often incredibly precise.
Embrace venv: 
Even within Docker, virtual environments are best practice for dependency management.

Install Prerequisites: 
- Don't assume all modules are present in minimal base images; install what you need.
- Keep Dockerfiles Lean & Intentional and remove any code that doesn't serve a direct purpose to prevent unexpected errors.
- Iterate and Test each fix. Each fix should be followed by a rebuild and test to confirm resolution before proceeding.
